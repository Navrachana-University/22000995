...
{
      26,     0,    -1,    26,    27,    23,    -1,    26,    27,    -1,
      27,    23,    -1,    27,    -1,     3,    28,    22,    -1,     4,
      28,    27,    -1,     4,    28,    27,     5,    27,    -1,     6,
      28,    27,    -1,     7,    -1,    28,    16,    28,    -1,    28,
...
{
       0,    43,    43,    44,    45,    46,    53,    57,    58,    59,
      75,    82,    92,   102,   112,   122
};
#endif
...
{
  "$end", "error", "$undefined", "DIKHANA", "IF", "ELSE", "WHILE",
  "NUMBER", "ID", "EQ", "NE", "LE", "GE", "LT", "GT", "ASSIGN", "PLUS",
  "MINUS", "MUL", "DIV", "LPAREN", "RPAREN", "SEMICOLON", "'\\n'", "IFX",
...
{
      41,     6,     6,     6,    31,   -20,   -21,     6,    11,    -2,
      -2,   -21,   -12,   -21,    22,     6,     6,     6,     6,   -21,
      13,   -21,   -21,   -21,    -9,    -9,   -21,   -21,    41,   -21
};
...
{
      12,     1,     2,    13,     3,    20,    21,     9,    10,    17,
      18,    22,    14,     6,    15,    16,    17,    18,    28,     0,
      24,    25,    26,    27,    29,     0,     7,    15,    16,    17,
      18,    11,     0,    19,     1,     2,     0,     3,    15,    16,
      17,    18,     0,    23,     1,     2,     0,     3
};

static const yytype_int8 yycheck[] =
{
       4,     3,     4,    23,     6,     9,    10,     2,     3,    18,
      19,    23,     7,     7,    16,    17,    18,    19,     5,    -1,
      15,    16,    17,    18,    28,    -1,    20,    16,    17,    18,
      19,     0,    -1,    22,     3,     4,    -1,     6,    16,    17,
      18,    19,    -1,    21,     3,     4,    -1,     6
};
...
{
       0,     3,     4,     6,    26,    27,     7,    20,    28,    28,
      28,     0,    27,    23,    28,    16,    17,    18,    19,    22,
      27,    27,    23,    21,    28,    28,    28,    28,     5,    27
};
...
/* Line 1455 of yacc.c  */
#line 58 "parser.y"
    { printf("IF-ELSE executed with %s\n", (yyvsp[(2) - (5)].str)); ;}
    break;
...
#line 59 "parser.y"
    {
        ...
        sprintf(tac[tacIndex++], "ifFalse %s goto %s", (yyvsp[(2) - (3)].str), endLabel);    // Check condition
...
#line 75 "parser.y"
    {
        char* t = newTemp();
        sprintf(tac[tacIndex++], "%s = %d", t, (yyvsp[(1) - (1)].num));
        printf("TAC: %s\n", tac[tacIndex - 1]); // Debug print
        tempValues[tempCount - 1] = (yyvsp[(1) - (1)].num);
        (yyval.str) = t;
    ;}
    break;
...
#line 82 "parser.y"
    {
        char* t = newTemp();
        int idx1 = atoi((yyvsp[(1) - (3)].str) + 1);
        int idx2 = atoi((yyvsp[(3) - (3)].str) + 1);
        int result = tempValues[idx1] + tempValues[idx2];
        sprintf(tac[tacIndex++], "%s = %s + %s", t, (yyvsp[(1) - (3)].str), (yyvsp[(3) - (3)].str));
        printf("TAC: %s\n", tac[tacIndex - 1]); // Debug print
